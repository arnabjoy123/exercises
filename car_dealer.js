...
//     if (i.id === el) {
//       console.log(`Car ${el} is a ${i.car_year} ${i.car_make} ${i.car_model}`);
//       return;
//     }
//   }
// }
...
//     if (p === inventory[lastIndex]) {
//       console.log(`Last car is a ${p.car_make} ${p.car_model}`);
//     }
//   }
// }
